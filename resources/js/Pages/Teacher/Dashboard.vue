<template>
  <AppLayout title="Dashboard Profesor">
    <template #header>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600 mt-1">
                Dashboard-ul tău de profesor - gestionează cursurile, evenimentele și activitățile
              </p>
            </div>
            <div class="text-right">
              <p class="text-sm text-gray-500">Rol: {{ $page.props.auth.user.role_label }}</p>
              <p class="text-sm text-gray-500">{{ $page.props.auth.user.department }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <i class="fas fa-chalkboard-teacher text-2xl text-blue-500"></i>
              </div>
              <div class="ml-4">
                <p class="text-sm font-medium text-gray-500">Cursuri Active</p>
                <p class="text-2xl font-semibold text-gray-900">{{ stats.courses || 0 }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-sm font-medium text-gray-500">Evenimente</p>
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">{{ stats.documents || 0 }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="space-y-3">
              ...
              <Link
                :href="route('teacher.calendar-events.create')"
              ...
              <Link
                :href="route('teacher.documents.create')"
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="space-y-3">
              ...
              <Link
                :href="route('teacher.calendar.index')"
                class="inline-flex items-center w-full px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
              >
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Comunitate</h3>
            <div class="space-y-3">
              <Link
                :href="route('teacher.forum.index')"
                class="inline-flex items-center w-full px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
              >
              ...
              <Link
                :href="route('teacher.members.index')"
                class="inline-flex items-center w-full px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
              >
