<template>
  <AppLayout title="Dashboard Companie">
    <template #header>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-lg font-medium text-gray-900">Bun venit, {{ $page.props.auth.user.company_name }}!</h3>
              <p class="text-sm text-gray-600 mt-1">
                Dashboard-ul companiei tale - gestionează joburile, aplicațiile și colaborările
              </p>
            </div>
            <div class="text-right">
              <p class="text-sm text-gray-500">Rol: {{ $page.props.auth.user.role_label }}</p>
              <p class="text-sm text-gray-500">{{ $page.props.auth.user.company_type }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-sm font-medium text-gray-500">Joburi Active</p>
                <p class="text-2xl font-semibold text-gray-900">{{ stats.active_jobs || 0 }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-sm font-medium text-gray-500">Aplicații Primite</p>
                <p class="text-2xl font-semibold text-gray-900">{{ stats.received_applications || 0 }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-sm font-medium text-gray-500">Candidați Scurtlistați</p>
                <p class="text-2xl font-semibold text-gray-900">{{ stats.shortlisted_candidates || 0 }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">{{ stats.participating_events || 0 }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="space-y-3">
              ...
              <Link
                :href="route('company.members.index')"
                class="inline-flex items-center w-full px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
              >
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="space-y-3">
              ...
              <Link
                :href="route('company.forum.index')"
                class="inline-flex items-center w-full px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
              >
